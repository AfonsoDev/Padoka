...
<body>
    ...
    <?php echo(cabecalho());?>
        ...
        <div class="container">
            <div class="divInput">
                <input type="text" class="buscarFiltro" name="" id="buasca" size="20">
            ...
            <div class="containerItens">
                <table id="table">
                    ...
                    <?php
                        ...
                        tblcontatos.celular,
                        tblcontatos.email,
                        tblsugestaocritica.opcao
                        from
                        tblcontatos,tblsugestaocritica
                        where
                        tblsugestaocritica.IdSugestaoCritica = tblcontatos.idSugestaoCritica
